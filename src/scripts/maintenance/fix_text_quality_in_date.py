#!/usr/bin/env python3
"""Fix ImageTextQuality in_date based on image path parsing."""
...
def fix_text_quality_in_date(
    ...
    logger.info("[TEXT_QUALITY_FIX] Report: {}", report)
    return report


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fix ImageTextQuality.in_date using filename collection_date."
    )
    parser.add_argument(
        "--room-id",
        action="append",
