...
```bash
# 运行决策分析
python scripts/analysis/run_decision_analysis.py --room-id 611

# 运行环境统计
python scripts/analysis/run_env_stats.py --room-id 611 --date 2024-01-15

# 运行可视化
python scripts/analysis/run_visualization.py --room-id 611
```
...
```bash
# 处理最近的图像
python scripts/processing/process_recent_images.py

# 处理最近一小时的图像
python scripts/processing/process_recent_hour_images.py

# 计算历史环境统计
python scripts/processing/compute_historical_env_stats.py --start-date 2024-01-01 --end-date 2024-01-31
```
