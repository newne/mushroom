...
class SetpointAnalytics:
    ...
    def get_change_statistics(self, room_id: Optional[str] = None, 
        ...
        try:
            ...
            SELECT 
                ...
                AVG(change_magnitude) as avg_change_magnitude,
                MAX(change_magnitude) as max_change_magnitude
            ...
            device_type_stats = pd.read_sql(device_type_query, pgsql_engine, params=params)
    ...
    def get_hourly_change_pattern(self, room_id: Optional[str] = None,
        ...
        try:
            ...
            where_conditions = ["change_time >= :start_date", "change_time <= :end_date"]
    ...
    def get_device_change_frequency(self, room_id: Optional[str] = None,
    ...
    def get_change_timeline(self, room_id: Optional[str] = None,
        ...
        try:
            ...
            where_conditions = ["change_time >= :start_time", "change_time <= :end_time"]
    ...
    def detect_abnormal_changes(self, room_id: Optional[str] = None,
        ...
        try:
            ...
            SELECT 
                ...
                change_magnitude,
                change_detail,
                (SELECT AVG(change_magnitude) FROM device_setpoint_changes WHERE {where_clause}) as avg_magnitude,
                (SELECT STDDEV(change_magnitude) FROM device_setpoint_changes WHERE {where_clause}) as std_magnitude
            FROM device_setpoint_changes
            WHERE {where_clause} AND change_magnitude > 0
            """
            ...
            if not magnitude_df.empty and len(magnitude_df) > 1:
                ...
                if std_magnitude > 0:
                    ...
                    large_changes = magnitude_df[magnitude_df['change_magnitude'] > magnitude_threshold]
    ...
    def generate_summary_report(self, room_id: Optional[str] = None,
        ...
        try:
            ...
            if not device_frequency.empty:
                ...
                most_active_devices = top_devices[['device_name', 'device_type', 'total_changes', 'changes_per_day']].to_dict('records')
